...
int main()
{
	...
	char dstft[15] = "yeti";
    char srcft[] = "salut";
    int size = strlcat(dst, src, 3);
	int sizeft = ft_strlcat(dstft, srcft, 3);
	printf("TEST 1 SYS");
	...
	char dstft1[15] = "yeti";
    char srcft1[] = "";
    int size1 = strlcat(dst1, src1, 4);
	int sizeft1 = ft_strlcat(dstft1, srcft1, 4);
	...
	char dstft2[15] = "";
    char srcft2[] = "coucou";
    int size2 = strlcat(dst2, src2, 10);
	int sizeft2 = ft_strlcat(dstft2, srcft2, 10);
    ...
    int size3 = strlcat(dst3, src3, 15);
	int sizeft3 = ft_strlcat(dstft3, srcft3, 15);
	printf("TEST 4a SYS");
    ...
    char srcft4[] = "yodl";
    int size4 = strlcat(dst4, src4, 4);
	int sizeft4 = ft_strlcat(dstft4, srcft4, 4);
	printf("TEST 4 SYS");
    ...
    char srcft5[] = "yodl";
    int size5 = strlcat(dst5, src5, 8);
	int sizeft5 = ft_strlcat(dstft5, srcft5, 8);
	printf("TEST 5 SYS");
